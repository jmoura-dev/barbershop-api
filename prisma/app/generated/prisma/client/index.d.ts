...
export namespace Prisma {
  ...
  */
  ...
  > = {
    ...
    meta: {
      modelProps: 'user' | 'comment' | 'schedule'
   ...
   * UserCountOutputType without action
   */
  export type UserCountOutputTypeCountScheduleArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  export type UserOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'id' | 'name' | 'email' | 'password_hash' | 'whatsapp_number' | 'role',
    ExtArgs['result']['user']
  >
  ...
  type GetScheduleGroupByPayload<T extends ScheduleGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  type ScheduleGetPayload<
    S extends boolean | null | undefined | ScheduleDefaultArgs,
  > = $Result.GetResult<Prisma.$SchedulePayload, S>
  ...
  > {
    ...
    updateManyAndReturn<T extends ScheduleUpdateManyAndReturnArgs>(
      args: SelectSubset<T, ScheduleUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$SchedulePayload<ExtArgs>,
        T,
    ...
    >(
      args: SubsetIntersection<T, ScheduleGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetScheduleGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>
    /**
  ...
  interface ScheduleFieldRefs {
    ...
    readonly cutValue: FieldRef<'Schedule', 'Decimal'>
    readonly status: FieldRef<'Schedule', 'Boolean'>
    readonly typeOfCut: FieldRef<'Schedule', 'String'>
  ...
  export type ScheduleWhereInput = {
    ...
    cutValue?:
      | DecimalFilter<'Schedule'>
      | Decimal
      | DecimalJsLike
      | number
      | string
    status?: BoolFilter<'Schedule'> | boolean
    typeOfCut?: StringFilter<'Schedule'> | string
  ...
  export type ScheduleScalarWhereWithAggregatesInput = {
    ...
    cutValue?:
      | DecimalWithAggregatesFilter<'Schedule'>
      | Decimal
      | DecimalJsLike
      | number
      | string
    status?: BoolWithAggregatesFilter<'Schedule'> | boolean
    typeOfCut?: StringWithAggregatesFilter<'Schedule'> | string
  ...
  export type ScheduleCreateInput = {
    ...
    date: string
    time: string
    cutValue: Decimal | DecimalJsLike | number | string
    status: boolean
    typeOfCut: string
    createdAt?: Date | string
  ...
  export type ScheduleUpdateInput = {
    ...
    typeOfCut?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
